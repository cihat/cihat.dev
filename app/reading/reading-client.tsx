...
export default function ReadingClient() {
  ...
  const inProgressBooks = localBooks
  ...
  const completedBooks = localBooks.filter((book: BookType) => getProgress(book.currentPage, book.page) === 100)
  const willReadBooks = localBooks.filter((book: BookType) => book.currentPage === 0)
